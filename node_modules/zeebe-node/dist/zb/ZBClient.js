...
class ZBClient extends TypedEmitter_1.TypedEmitter {
    ...
    publishMessage(publishMessageRequest) {
        return this.executeOperation('publishMessage', () => this.grpc.publishMessageSync((0, lib_1.stringifyVariables)(publishMessageRequest)));
    }
    /**
    ...
    publishStartMessage(publishStartMessageRequest) {
        ...
        return this.executeOperation('publishStartMessage', () => this.grpc.publishMessageSync((0, lib_1.stringifyVariables)(publishMessageRequest)));
    }
    /**
     *
